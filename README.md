...
[![Demo](https://img.shields.io/badge/Ζήτησε-Demo-22c55e?style=for-the-badge)](#-επικοινωνία)
[![Security](https://img.shields.io/badge/Penetration-Tested-0d5eaf?style=for-the-badge&logo=shieldsdotio&logoColor=white)](#-ασφάλεια--έλεγχος)
...
[![License](https://img.shields.io/badge/Άδεια-Proprietary-1f2937?style=for-the-badge)](LICENSE)
...
Διαφανής τιμολόγηση, με τον μήνα — ανά χρήστη/μήνα, με ένα αρχικό κόστος υλοποίησης.

| | **Starter** | **Business** ⭐ _Δημοφιλέστερο_ | **Enterprise** |
|---|---|---|---|
| **Τιμή** | από **9€** /χρήστη/μήνα | από **19€** /χρήστη/μήνα | **Custom** |
...
> 💡 On-premise τιμές χαμηλότερες (Starter 8€, Business 16€/χρήστη/μήνα). _Ενδεικτικές τιμές — η τελική προσφορά διαμορφώνεται μετά την ανάλυση αναγκών._ [**Ζήτησε προσφορά**](#-επικοινωνία).
